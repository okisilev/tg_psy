...
echo "✅ prodamus.py обновлен с 15 вариантами проверки подписи"
...
echo ""
echo "📋 Теперь webhook будет пробовать 15 разных вариантов подписи!"
echo "🔧 Это должно решить проблему с подписью от Prodamus!"
